...
def dataprep(puf, Stage_I_factors, Stage_II_targets, year):
    ...
    interest_1 = np.where(puf.e00100 <= 0, puf.e00300, 0) * s006
    interest_2 = np.where((puf.e00100 > 0) & (puf.e00100 <= 10000), puf.e00300, 0) * s006
    interest_3 = (
        np.where((puf.e00100 > 10000) & (puf.e00100 <= 20000), puf.e00300, 0) * s006
    )
    interest_4 = (
        np.where((puf.e00100 > 20000) & (puf.e00100 <= 30000), puf.e00300, 0) * s006
    )
    interest_5 = (
        np.where((puf.e00100 > 30000) & (puf.e00100 <= 40000), puf.e00300, 0) * s006
    )
    interest_6 = (
        np.where((puf.e00100 > 40000) & (puf.e00100 <= 50000), puf.e00300, 0) * s006
    )
    interest_7 = (
        np.where((puf.e00100 > 50000) & (puf.e00100 <= 75000), puf.e00300, 0) * s006
    )
    interest_8 = (
        np.where((puf.e00100 > 75000) & (puf.e00100 <= 100000), puf.e00300, 0) * s006
    )
    interest_9 = (
        np.where((puf.e00100 > 100000) & (puf.e00100 <= 200000), puf.e00300, 0) * s006
    )
    interest_10 = (
        np.where((puf.e00100 > 200000) & (puf.e00100 <= 500000), puf.e00300, 0) * s006
    )
    interest_11 = (
        np.where((puf.e00100 > 500000) & (puf.e00100 <= 1000000), puf.e00300, 0) * s006
    )
    interest_12 = np.where(puf.e00100 > 1000000, puf.e00300, 0) * s006
    ...
    target_name = "Taxable Interest Income: Zero or Less"
    INTEREST_1 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_1.sum())
    target_name = "Taxable Interest Income: $1 Less Than $10,000"
    INTEREST_2 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_2.sum())
    target_name = "Taxable Interest Income: $10,000 Less Than $20,000"
    INTEREST_3 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_3.sum())
    target_name = "Taxable Interest Income: $20,000 Less Than $30,000"
    INTEREST_4 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_4.sum())
    target_name = "Taxable Interest Income: $30,000 Less Than $40,000"
    INTEREST_5 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_5.sum())
    target_name = "Taxable Interest Income: $40,000 Less Than $50,000"
    INTEREST_6 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_6.sum())
    target_name = "Taxable Interest Income: $50,000 Less Than $75,000"
    INTEREST_7 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_7.sum())
    target_name = "Taxable Interest Income: $75,000 Less Than $100,000"
    INTEREST_8 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_8.sum())
    target_name = "Taxable Interest Income: $100,000 Less Than $200,000"
    INTEREST_9 = (Stage_II_targets[ystr][target_name] *
              APOPN / AINTS * 1000 - interest_9.sum())
    target_name = "Taxable Interest Income: $200,000 Less Than $500,000"
    INTEREST_10 = (Stage_II_targets[ystr][target_name] *
               APOPN / AINTS * 1000 - interest_10.sum())
    target_name = "Taxable Interest Income: $500,000 Less Than $1 Million"
    INTEREST_11 = (Stage_II_targets[ystr][target_name] *
               APOPN / AINTS * 1000 - interest_11.sum())
    target_name = "Taxable Interest Income: $1 Million and Over"
    INTEREST_12 = (Stage_II_targets[ystr][target_name] *
               APOPN / AINTS * 1000 - interest_12.sum())

    ADIVS = Stage_I_factors[year]["ADIVS"]
    DIVIDEND = (Stage_II_targets[ystr]["Ordinary Dividends"] *
                APOPN / ADIVS * 1000 - dividend.sum())

    ASCHCI = Stage_I_factors[year]["ASCHCI"]
    BIZ_INCOME = (Stage_II_targets[ystr]["Business Income (Schedule C)"] *
                  APOPN / ASCHCI * 1000 - biz_income.sum())

    ASCHCL = Stage_I_factors[year]["ASCHCL"]
    BIZ_LOSS = (Stage_II_targets[ystr]["Business Loss (Schedule C)"] *
                APOPN / ASCHCL * 1000 - biz_loss.sum())

    ACGNS = Stage_I_factors[year]["ACGNS"]
    CAP_GAIN = (Stage_II_targets[ystr]["Net Capital Gains in AGI"] *
                APOPN / ACGNS * 1000 - cap_gain.sum())

    ATXPY = Stage_I_factors[year]["ATXPY"]
    target_name = "Taxable Pensions and Annuities"
    ANNUITY_PENSION = (Stage_II_targets[ystr][target_name] *
                       APOPN / ATXPY * 1000 - annuity_pension.sum())

    ASCHEI = Stage_I_factors[year]["ASCHEI"]
    target_name = "Supplemental Income (Schedule E)"
    SCH_E_INCOME = (Stage_II_targets[ystr][target_name] *
                    APOPN / ASCHEI * 1000 - sch_e_income.sum())

    ASCHEL = Stage_I_factors[year]["ASCHEL"]
    SCH_E_LOSS = (Stage_II_targets[ystr]["Supplemental Loss (Schedule E)"] *
                  APOPN / ASCHEL * 1000 - sch_e_loss.sum())

    ASOCSEC = Stage_I_factors[year]["ASOCSEC"]
    APOPSNR = Stage_I_factors[year]["APOPSNR"]
    SS_INCOME = (Stage_II_targets[ystr]["Gross Social Security Income"] *
                 APOPSNR / ASOCSEC * 1000 - ss_income.sum())

    AUCOMP = Stage_I_factors[year]["AUCOMP"]
    UNEMPLOYMENT_COMP = (Stage_II_targets[ystr]["Unemployment Compensation"] *
                         APOPN / AUCOMP * 1000 - unemployment_comp.sum())

    AWAGE = Stage_I_factors[year]["AWAGE"]
    target_name = "Wages and Salaries: Zero or Less"
    WAGE_1 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_1.sum())
    target_name = "Wages and Salaries: $1 Less Than $10,000"
    WAGE_2 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_2.sum())
    target_name = "Wages and Salaries: $10,000 Less Than $20,000"
    WAGE_3 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_3.sum())
    target_name = "Wages and Salaries: $20,000 Less Than $30,000"
    WAGE_4 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_4.sum())
    target_name = "Wages and Salaries: $30,000 Less Than $40,000"
    WAGE_5 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_5.sum())
    target_name = "Wages and Salaries: $40,000 Less Than $50,000"
    WAGE_6 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_6.sum())
    target_name = "Wages and Salaries: $50,000 Less Than $75,000"
    WAGE_7 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_7.sum())
    target_name = "Wages and Salaries: $75,000 Less Than $100,000"
    WAGE_8 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_8.sum())
    target_name = "Wages and Salaries: $100,000 Less Than $200,000"
    WAGE_9 = (Stage_II_targets[ystr][target_name] *
              APOPN / AWAGE * 1000 - wage_9.sum())
    target_name = "Wages and Salaries: $200,000 Less Than $500,000"
    WAGE_10 = (Stage_II_targets[ystr][target_name] *
               APOPN / AWAGE * 1000 - wage_10.sum())
    target_name = "Wages and Salaries: $500,000 Less Than $1 Million"
    WAGE_11 = (Stage_II_targets[ystr][target_name] *
               APOPN / AWAGE * 1000 - wage_11.sum())
    target_name = "Wages and Salaries: $1 Million and Over"
    WAGE_12 = (Stage_II_targets[ystr][target_name] *
               APOPN / AWAGE * 1000 - wage_12.sum())

    temp = [INTEREST_1,
            INTEREST_2, INTEREST_3, INTEREST_4, INTEREST_5, INTEREST_6,
            INTEREST_7, INTEREST_8, INTEREST_9, INTEREST_10, INTEREST_11, 
            INTEREST_12,
            DIVIDEND, BIZ_INCOME, BIZ_LOSS, CAP_GAIN,
